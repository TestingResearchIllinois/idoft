...
if __name__ == "__main__":
    ...
    checks = [lambda *args: run_checks_pr('pr-data.csv', *args), lambda *args: run_checks_pr('gr-data.csv', *args), lambda *args: run_checks_pr('py-data.csv', *args), run_checks_tic_fic, run_checks_tso_iso]
    for check in checks:
