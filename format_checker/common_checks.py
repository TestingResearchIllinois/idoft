...
def check_sort(filename, log):
    ...
    if diff != "":
        ...
        print("Refer to IDoFT readme for how pr-data.csv, gr-data.csv should be sorted: https://github.com/TestingResearchIllinois/idoft#to-contribute-a-newly-detected-flaky-test")
