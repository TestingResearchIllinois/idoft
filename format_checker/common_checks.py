...
def check_sort(filename, log):
    ...
    if diff != "":
        ...
        print("Refer to IDoFT readme for how " + filename +
              " should be sorted: https://github.com/TestingResearchIllinois/"
              "'idoft#to-contribute-a-newly-detected-flaky-test")
